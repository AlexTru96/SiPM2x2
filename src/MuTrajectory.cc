...
G4Allocator<MuTrajectory> MuTrajectoryAllocator;
...
MuTrajectory::MuTrajectory(const G4Track* aTrack)
...
MuTrajectory::MuTrajectory(MuTrajectory &right)
...
void MuTrajectory::DrawTrajectory() const
{
...
void MuTrajectory::DrawTrajectory(G4int i_mode) const{
