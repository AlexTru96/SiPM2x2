...
#ifndef MuUserEventInformation_h
#define MuUserEventInformation_h 1

class MuUserEventInformation : public G4VUserEventInformation
{
  public:

    MuUserEventInformation();
    virtual ~MuUserEventInformation();
